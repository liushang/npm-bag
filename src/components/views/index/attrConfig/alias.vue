<template>
<div>
<div style="padding: 5px 0 5px 40px" v-for="(x) in propertyList" :key="x">
    <span>
    ...
    <span>
        ...
        <!-- <el-input  size="mini" v-model="activeData[rootWord]" placeholder="请输入字段名（v-model）" style="width: 165px" v-if="['string', 'number', 'boolean'].includes(typeof activeData[rootWord]) && initialTypeShow === 'input'" /> -->
